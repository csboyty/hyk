...
from flask import current_app, request, redirect, send_file, jsonify, render_template, send_from_directory, session
...
def init_user_manager(app):
    ...
    user_manager = UserManager(db_adapter, login_view_function=login,
